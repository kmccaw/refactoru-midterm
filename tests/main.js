// Define a wrapper class for image data
var Img = function(imageData)
{
	this.pixels = imageData.data.slice();
	this.width = imageData.width;
	this.height = imageData.height;
};
Img.prototype.R = (function(x,y,val)
{
	if (!(x && y))
		return null;
	if (val)
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			this.pixels[4*(y*this.height+x)] = val;
			return true;
		}
		else
			return false;
	...
	else
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			return this.pixels[4*(y*this.height+x)];
		}
		else
			return -1;
	}
});
Img.prototype.G = (function(x,y,val)
{
	if (!(x && y))
		return null;
	if (val)
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			this.pixels[4*(y*this.height+x) + 1] = val;
			return true;
		}
		else
			return false;
	...
	else
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			return this.pixels[4*(y*this.height+x) + 1];
		}
		else
			return -1;
	}
});
Img.prototype.B = (function(x,y,val)
{
	if (!(x && y))
		return null;
	if (val)
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			this.pixels[4*(y*this.height+x) + 2] = val;
			return true;
		}
		else
			return false;
	...
	else
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			return this.pixels[4*(y*this.height+x) + 2];
		}
		else
			return -1;
	}
});
Img.prototype.A = (function(x,y,val)
{
	if (!(x && y))
		return null;
	if (val)
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			this.pixels[4*(y*this.height+x) + 3] = val;
			return true;
		}
		else
			return false;
	...
	else
	{
		if (x >= 0 && x < this.width
			&& y >= 0 && y < this.height)
		{
			return this.pixels[4*(y*this.height+x) + 3];
		}
		else
			return -1;
	}
